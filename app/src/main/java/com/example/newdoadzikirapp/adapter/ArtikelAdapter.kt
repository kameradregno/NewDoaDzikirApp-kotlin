...
import com.example.newdoadzikirapp.databinding.FragmentArtikelBinding
import com.example.newdoadzikirapp.model.ArtikelModel
import com.example.newdoadzikirapp.ui.detail.DetailArtikelActivity
...
class ArtikelAdapter  (private val listArtikel: ArrayList<ArtikelModel>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            FragmentArtikelBinding.inflate(LayoutInflater.from(parent.context), parent, false)
